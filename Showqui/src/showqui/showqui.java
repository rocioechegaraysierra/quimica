...
public class showqui extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(156, 156, 156)
                        .addComponent(jLabel19, javax.swing.GroupLayout.PREFERRED_SIZE, 914, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
      ...
      jTextArea1.setText("El anillo es un aro con más o menos decoración que se utiliza como adorno de los dedos de las manos.");
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
      ...
      jTextArea1.setLineWrap(true);
      jTextArea1.setWrapStyleWord(true);
      jTextArea1.setText("Cualquiera de los instrumentos empleados de forma manual para comer, cortar, preparar y especialmente ingerir alimentos. Los utensilios que componen la cubertería occidental son generalmente los tenedores, las cucharas y los cuchillos.");
      jTextArea2.setLineWrap(true);
      jTextArea2.setWrapStyleWord(true);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
      ...
      jTextArea1.setLineWrap(true);
      jTextArea1.setWrapStyleWord(true);
      jTextArea1.setText("Una radiografía es una técnica diagnóstica radiológica de forma digital (radiología digital directa o indirecta) en una base de datos. La imagen se obtiene al exponer al receptor de imagen radiográfica a una fuente de radiación de alta energía, comúnmente rayos X o radiación gamma procedente de isótopos radiactivos. Al interponer un objeto entre la fuente de radiación y el receptor, las partes más densas aparecen con diferentes tonos dentro de una escala de grises.");
      jTextArea2.setLineWrap(true);
      jTextArea2.setWrapStyleWord(true);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
      ...
      jTextArea1.setLineWrap(true);
      jTextArea1.setWrapStyleWord(true);
      jTextArea1.setText("Una piscina es un estanque artificial destinado al baño y deportes como la natación. Asimismo, existen varias modalidades, como las fijas, las portátiles y las desmontables. Y de distintos materiales, como acero inoxidable, poliéster, de hormigón armado, recubiertas de mosaico, etc.");
      jTextArea2.setLineWrap(true);
      jTextArea2.setWrapStyleWord(true);
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
      ...
      jTextArea1.setLineWrap(true);
      jTextArea1.setWrapStyleWord(true);
      jTextArea1.setText("La sal común o sal de mesa, conocida popularmente como sal, es un tipo de sal denominada cloruro sódico (o cloruro de sodio), cuya fórmula química es NaCl. Existen tres tipos de sal común, según su procedencia: la sal marina y la de manantial, que se obtienen por evaporación; la sal gema, que procede de la extracción minera de una roca mineral denominada halita, y la sal vegetal, que se obtiene por concentración, al hervir una planta gramínea.");
      jTextArea2.setLineWrap(true);
      jTextArea2.setWrapStyleWord(true);
